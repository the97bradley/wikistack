...
module.exports = () => layout(
  ...
  <div class="col-sm-10">
    ...
    <div class="col-sm-10">
      <textarea id="content" name="content" type="text" cols="15" rows="8" class="form-control"></textarea>
    </div>
  </div>
  ...
  <div class="col-sm-10">
    <input id="open" name="status" type="radio" value="open" class="form-control"/>
    <label>Open</label>
    <input id="closed" name="status" type="radio" value="closed" class="form-control"/>
    <label>Closed</label>
  </div>
</div>
